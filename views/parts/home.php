...
<div class="container">
        ...
        <div class="portfolio-item row">
            ...
            <div class="item mt-3 gts col-lg-3 col-md-4 col-6 col-sm">
            ...
            <div class="item mt-3 gts col-lg-3 col-md-4 col-6 col-sm">
                <a href="https://image.freepik.com/free-photo/cute-girls-oin-studio_1157-18211.jpg"
                    class="fancylight popup-btn" data-fancybox-group="light">
                    <img class="img-fluid"
                        src="https://image.freepik.com/free-photo/cute-girls-oin-studio_1157-18211.jpg" alt="">
                </a>
            </div>
            <div class="item mt-3 gts col-lg-3 col-md-4 col-6 col-sm">
            ...
            <div class="item mt-3 lap col-lg-3 col-md-4 col-6 col-sm">
            ...
            <div class="item mt-3 selfie col-lg-3 col-6 col-sm">
        ...
        <center class="mx-2">
            <div class="row">
                <div class="col-md-12">
                    <button type="button" class="btn btn-success" id="load_more" name="Load_more">Load more</button>
                </div>
            </div>
        </center>
    </div>
